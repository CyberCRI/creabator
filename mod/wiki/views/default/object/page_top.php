...
// wiki used to use Public for write access
...
$page_icon = elgg_view('wiki/icon', array('annotation' => $annotation, 'size' => 'small'));
...
$editor_text = elgg_echo('wiki:strapline', array($date, $editor_link));

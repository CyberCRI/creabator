...
// sponsors 
$img1=elgg_view('output/img',array('src'=>elgg_get_site_url().'mod/ib_index/graphics/sponsors/cri.png','alt'=>'Centre for Research and Interdisciplinarity (CRI)','class'=>'w200 h100 bgwhite'));
$img2=elgg_view('output/img',array('src'=>elgg_get_site_url().'mod/ib_index/graphics/sponsors/ccl.png','alt'=>'CitizenCyber Lab','class'=>'w200 h100 bgwhite'));
$img3=elgg_view('output/img',array('src'=>elgg_get_site_url().'mod/ib_index/graphics/sponsors/fp7.jpg','alt'=>'European Commission','class'=>'w200 h100 bgwhite'));
...
offset=eval(offset)+eval('3');
$(this).attr('id',offset);

var prev_id=$(".list_prev").attr('id');
$(".list_prev").attr('id',eval(prev_id)+eval('3'));
});
...
$(".list_next").attr('id',eval(next_id)-eval('3'));
}
});
